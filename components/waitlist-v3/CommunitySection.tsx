...
const CARDS: CommunityCard[] = [
  {
    ...
    count: '2,437',
    countLabel: 'members',
    description: 'Real-time alpha, builder channels, agent demos',
    tags: ['Live Chat', 'Agent Alerts', 'Builder Logs'],
    accent: 'violet',
    cta: 'Join Discord',
    href: '#',
  },
  {
    ...
    count: '890',
    countLabel: 'members',
    description: 'Direct access to founder updates and launches',
    tags: ['Updates', 'Launches', 'Insights'],
    accent: 'cyan',
    cta: 'Join Telegram',
    href: '#',
  },
  {
    ...
    count: '847',
    countLabel: 'builders',
    description: 'Priority access to the APEX OS platform',
    tags: ['Early Access', 'AI Scoring', 'Referrals'],
    accent: 'emerald',
    cta: 'Apply Below ↓',
    href: '#apply',
  },
